function tema() {
    ...
    if (tema.getAttribute('id_tema') == 1){
        ...
        var newCorTituloNotaSalvo = "white";
    } else {
        ...
        var newCorTituloNotaSalvo = "#5E617F";
    }
    ...
    document.getElementById('tituloNotasSalvas').style.color = newCorTituloNotaSalvo;
}
...
function exibirNotas() {
    ...
    if (notas.length > 0) {
        ...
        notas.forEach((nota, index) => {
            ...
            contagemnotas.innerHTML = `Você possui ${notas.length} nota(s)`;

        });
    } else {
        document.getElementById('notasSalvas').style.display = 'none';
        contagemnotas.innerHTML = '';
    }
}
